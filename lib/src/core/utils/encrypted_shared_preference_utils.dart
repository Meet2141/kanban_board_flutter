...
/// This file contains methods used for storing information on encrypted shared preferences (local dynamic storage).
class EncryptedSharedPreferencesUtils {
  ...
  EncryptedSharedPreferencesUtils({this.prefs, this.mode = AESMode.sic});
